...
class __TwigTemplate_71daa153e252bbaea6116016b815d1e21dffdb4b395219137fe0ae042aed9397 extends Twig_Template
{
...
";
    ...
    {
        return "{% if uri.extension() == 'json' %}{% include 'default.json.twig' %}{% else %}
    <!DOCTYPE html>
    <html lang=\"en\">
    <head>
    {% block head %}
