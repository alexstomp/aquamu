...
class __TwigTemplate_12a534191d8116db9d589fd88837243bd08f9c16416e564881818fdfc76328c0 extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        echo "                        ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "email", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 19
            echo "                        ";
