...
/* config.html.twig */
class __TwigTemplate_8a9064c409f80d396a03e671e3d606fdb147497c6b64aacb837a02f039818843 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 6
        $context["title"] = (($this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.CONFIGURATION") . ": ") . $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter(("PLUGIN_ADMIN." . twig_upper_filter($this->env, (isset($context["config_slug"]) ? $context["config_slug"] : null)))));
        // line 8
...
";
    ...
    <h1><i class=\"fa fa-fw fa-wrench\"></i> ";
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter(("PLUGIN_ADMIN." . twig_upper_filter($this->env, (isset($context["config_slug"]) ? $context["config_slug"] : null)))), "html", null, true);
        echo "</h1>
";
    }
    ...
    <div class=\"alert notice\">";
        // line 31
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SAVE_LOCATION"), "html", null, true);
        echo ": <b>";
    ...
    <ul class=\"tab-bar\">
        ...
        if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => "admin.configuration_system", 1 => "admin.super"))) {
            ...
            // line 37
            echo "            ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SYSTEM"), "html", null, true);
            echo "
            ";
            // line 38
            if (((isset($context["config_slug"]) ? $context["config_slug"] : null) == "system")) {
        ...
        if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => "admin.configuration_site", 1 => "admin.super"))) {
            ...
            // line 45
            echo "            ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SITE"), "html", null, true);
            echo "
            ";
            // line 46
            if (((isset($context["config_slug"]) ? $context["config_slug"] : null) == "site")) {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["configuration"]) {
            ...
            if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => ("admin.configuration_" . $context["configuration"]), 1 => "admin.super"))) {
                ...
                if ((((($context["configuration"] != "system") && ($context["configuration"] != "site")) &&  !$this->getAttribute($this->getAttribute((isset($context["current_blueprints"]) ? $context["current_blueprints"] : null), "form", array()), "hidden", array())) &&  !twig_test_empty($this->getAttribute($this->getAttribute((isset($context["current_blueprints"]) ? $context["current_blueprints"] : null), "form", array()), "fields", array())))) {
                    ...
                    // line 56
                    echo "                        ";
                    echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter($context["configuration"])), "html", null, true);
                    echo "
                        ";
                    // line 57
                    if (((isset($context["config_slug"]) ? $context["config_slug"] : null) == $context["configuration"])) {
        ...
        if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => "admin.configuration_info", 1 => "admin.super"))) {
            ...
            // line 66
            echo "            ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.INFO"), "html", null, true);
            echo "
            ";
            // line 67
            if (((isset($context["config_slug"]) ? $context["config_slug"] : null) == "info")) {
