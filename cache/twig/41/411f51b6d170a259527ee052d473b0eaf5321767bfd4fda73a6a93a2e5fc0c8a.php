...
class __TwigTemplate_1df6197fbe154d7dc649eeff998dc919c01bc0af904f0d9c32287e72baa6882e extends Twig_Template
{
    ...
    public function block_prepend($context, array $blocks = array())
    {
        ...
        ";
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                // line 7
                echo call_user_func_array($this->env->getFilter('tu')->getCallable(), array($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "prepend", array())));
            } else {
                // line 9
...
";
    ...
    public function block_append($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "append", array())) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                // line 24
                echo call_user_func_array($this->env->getFilter('tu')->getCallable(), array($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "append", array())));
            } else {
                // line 26
